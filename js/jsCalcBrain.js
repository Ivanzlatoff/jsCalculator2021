        ...
        let operands = ['add', 'subtract', 'multiply', 'divide'];
        ...
        function updateDisplay(input) {
            ...
            if (display.innerHTML === "0" && operands.indexOf(input) === -1) {
                if (input === 'decimal') {
                    display.innerHTML = '0.'
